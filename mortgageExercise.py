...
payment_override (monthly or fortnightly)
initial_payment_breakdown (dic contain the initial payment breakdown for extra repayment)
mortgage_maturity (dic contain payment overfull term etc)
amortization_schedule (a list of dic the amortization schedule)
"""
"""
methods:
calculate_initial_payment_breakdown()
calculate_mortgage_maturity()
